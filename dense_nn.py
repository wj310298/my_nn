...
hidden2 = layers.Dense(100, kernel_regularizer=regularizers.l2())(layers.concatenate([x_input, hidden1]))
hidden2 = layers.BatchNormalization()(hidden2)
hidden2 = layers.ReLU()(hidden2)
hidden3 = layers.Dense(100, kernel_regularizer=regularizers.l2())(layers.concatenate([x_input, hidden1, hidden2]))
...
y = layers.Dense(100, activation='sigmoid', kernel_regularizer=regularizers.l2())(
    layers.concatenate([x_input, hidden1, hidden2, hidden3]))
